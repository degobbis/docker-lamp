...
Also needed is to add your domains in your .env file for SSL_DOMAINS and DNS_A.

Example for .env file:
``DNS_A="*.local=0.0.0.0,*.test=0.0.0.0,example.org=0.0.0.0,www.example.org=0.0.0.0,other-example.org=0.0.0.0,www.example.org=0.0.0.0"``
